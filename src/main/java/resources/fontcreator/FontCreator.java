			...
			public void actionPerformed(ActionEvent arg0) {
					...
					public void approveSelection() {
						...
						if (file.exists() && getDialogType() == SAVE_DIALOG) {
							int result = JOptionPane.showConfirmDialog(this,
									...
									"Ovewrite file", JOptionPane.YES_NO_CANCEL_OPTION);
							switch (result) {
				...
				if (result == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						JOptionPane.showMessageDialog(component, ex.getMessage(), ex.getClass().getCanonicalName(),
								JOptionPane.ERROR_MESSAGE);
						ex.printStackTrace();
						return;
					}

					JOptionPane.showMessageDialog(component, "Font successfully saved at " + file.getAbsolutePath(),
